...
(async () => {
  ...
  assert(result.scripts.some(x => x.includes('exam-prep/exam-prep-api.js?v=p014h1') || x.includes('exam-prep/exam-prep-api.js?v=p209map1') || x.includes('exam-prep/exam-prep-api.js?v=p210materials1') || x.includes('exam-prep/exam-prep-api.js?v=p213placement2') || x.includes('exam-prep/exam-prep-api.js?v=p213placement3') || x.includes('exam-prep/exam-prep-api.js?v=p214projection1')), 'Exam Prep host API script missing');
