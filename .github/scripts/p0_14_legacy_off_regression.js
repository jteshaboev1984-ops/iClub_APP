...
(async () => {
  ...
  assert(result.scripts.some(x => x.includes('exam-prep/exam-prep-api.js?v=p014h1') || x.includes('exam-prep/exam-prep-api.js?v=p209map1') || x.includes('exam-prep/exam-prep-api.js?v=p210materials1')), 'Exam Prep host API script missing');
