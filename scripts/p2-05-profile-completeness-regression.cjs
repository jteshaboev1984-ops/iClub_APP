...
assert(api.includes('exam-prep-profile-completeness.js?v=p205profile1'), 'profile completeness guard is not loaded by Exam Prep API');
...
for (const text of [
  ...
  'Уже накопленный прогресс сохранится',
  'Oldingi natijalaringiz saqlanadi',
  'Your existing progress will be kept'
