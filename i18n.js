...
profile_settings_support_title: "Поддержка",
profile_settings_support_sub: "FAQ и обращение к администратору",

support_title: "Поддержка",
support_sub: "Быстрые ответы и обращение к администратору.",
support_contact_title: "Связаться с поддержкой",
support_contact_sub: "Если быстрые ответы не помогли, опишите проблему. После сохранения обращения откроется Telegram.",
...
support_select_topic_to_continue: "Выберите тему, чтобы увидеть быстрые ответы.",
support_select_topic_first: "Сначала выберите тему.",
support_message_required: "Опишите проблему перед отправкой.",
support_ticket_saved: "Обращение сохранено. Сейчас откроется Telegram.",
...
community_join: "Qo‘shilish",
       ...
       profile_settings_support_title: "Yordam",
profile_settings_support_sub: "FAQ va administratorga murojaat",

support_title: "Yordam",
support_sub: "Tez javoblar va administratorga murojaat.",
support_contact_title: "Yordamga murojaat qilish",
support_contact_sub: "Agar tez javoblar yordam bermasa, muammoni yozing. Murojaat saqlangandan keyin Telegram ochiladi.",
...
support_select_topic_to_continue: "Tez javoblarni ko‘rish uchun mavzuni tanlang.",
support_select_topic_first: "Avval mavzuni tanlang.",
support_message_required: "Yuborishdan oldin muammoni yozing.",
support_ticket_saved: "Murojaat saqlandi. Hozir Telegram ochiladi.",
...
community_join: "Join",
       ...
       profile_settings_support_title: "Support",
profile_settings_support_sub: "FAQ and contact admin",

support_title: "Support",
support_sub: "Quick answers and contact with admin.",
support_contact_title: "Contact support",
support_contact_sub: "If quick answers did not help, describe the problem. Telegram will open after the ticket is saved.",
...
support_select_topic_to_continue: "Choose a topic to see quick answers.",
support_select_topic_first: "Please choose a topic first.",
support_message_required: "Describe the problem before sending.",
support_ticket_saved: "Your request has been saved. Telegram will open now.",
