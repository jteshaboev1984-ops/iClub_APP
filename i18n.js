...
certificate_awarded_label: "Настоящий сертификат подтверждает",
certificate_for_subject_label: "за результат по предмету",
...
certificates_empty_title: "Сертификатов пока нет",
certificates_empty_hint: "Завершите активный тур, чтобы здесь появился ваш официальный результат.",
...
certificate_awarded_label: "Ushbu sertifikat tasdiqlaydi",
certificate_for_subject_label: "fan bo‘yicha natija uchun",
...
certificates_empty_title: "Hozircha sertifikatlar yo‘q",
certificates_empty_hint: "Faol turni yakunlang — bu yerda rasmiy natijangiz paydo bo‘ladi.",
...
certificate_awarded_label: "This certificate confirms",
certificate_for_subject_label: "for performance in the subject",
...
certificates_empty_hint: "Complete an active tour and your official result will appear here.",
