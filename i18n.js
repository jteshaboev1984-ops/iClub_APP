...
auth_login_subtitle: "Для входа используйте логин и пароль, созданные при регистрации или выданные вам администратором.",
auth_login_label: "Логин",
auth_login_placeholder: "например, jasurbek_01",
auth_password_label: "Пароль",
auth_password_placeholder: "Введите пароль",
auth_login_btn: "Войти",
       auth_new_user_btn: "Новый пользователь",
auth_back_to_login_btn: "Назад ко входу",

reg_country_label: "Страна",
reg_country_hint: "Пока основной фокус проекта — страны Центральной Азии.",
...
reg_auth_block_title: "Данные для входа",
reg_auth_block_subtitle: "Эти логин и пароль будут вашим входом в приложение.",
reg_login_label: "Логин",
reg_login_placeholder: "например, jasurbek_01",
reg_password_label: "Пароль",
reg_password_placeholder: "Минимум 6 символов",
reg_password_confirm_label: "Повторите пароль",
reg_password_confirm_placeholder: "Повторите пароль",

auth_invalid_login: "Введите корректный логин: только буквы, цифры и _ . -",
auth_invalid_password: "Пароль должен быть не короче 6 символов.",
auth_password_mismatch: "Пароли не совпадают.",
auth_login_taken: "Этот логин уже занят.",
auth_login_failed: "Не удалось войти. Проверьте логин и пароль.",
auth_signup_failed: "Не удалось создать аккаунт. Попробуйте ещё раз.",

force_password_title: "Смена пароля",
force_password_subtitle: "Для безопасности замените временный пароль на свой постоянный.",
force_password_new_label: "Новый пароль",
force_password_new_placeholder: "Минимум 6 символов",
force_password_confirm_label: "Повторите пароль",
force_password_confirm_placeholder: "Повторите пароль",
...
auth_login_subtitle: "Kirish uchun ro‘yxatdan o‘tishda yaratilgan yoki administrator bergan login va paroldan foydalaning.",
auth_login_label: "Login",
auth_login_placeholder: "masalan, jasurbek_01",
auth_password_label: "Parol",
auth_password_placeholder: "Parolni kiriting",
auth_login_btn: "Kirish",
       auth_new_user_btn: "Yangi foydalanuvchi",
auth_back_to_login_btn: "Kirishga qaytish",

reg_country_label: "Mamlakat",
reg_country_hint: "Hozircha loyiha asosan Markaziy Osiyo auditoriyasiga yo‘naltirilgan.",
       country_uz: "Oʻzbekiston",
country_kz: "Qozogʻiston",
country_kg: "Qirgʻiziston",
country_tj: "Tojikiston",
country_tm: "Turkmaniston",

reg_auth_block_title: "Kirish ma’lumotlari",
reg_auth_block_subtitle: "Ushbu login va parol ilovaga kirish uchun ishlatiladi.",
reg_login_label: "Login",
reg_login_placeholder: "masalan, jasurbek_01",
reg_password_label: "Parol",
reg_password_placeholder: "Kamida 6 ta belgi",
reg_password_confirm_label: "Parolni takrorlang",
reg_password_confirm_placeholder: "Parolni qayta kiriting",

auth_invalid_login: "Login faqat harflar, raqamlar va _ . - belgilaridan iborat bo‘lishi kerak.",
auth_invalid_password: "Parol kamida 6 ta belgidan iborat bo‘lishi kerak.",
auth_password_mismatch: "Parollar mos emas.",
auth_login_taken: "Bu login band.",
auth_login_failed: "Kirish amalga oshmadi. Login va parolni tekshiring.",
auth_signup_failed: "Akkaunt yaratib bo‘lmadi. Qayta urinib ko‘ring.",

force_password_title: "Parolni almashtirish",
force_password_subtitle: "Xavfsizlik uchun vaqtinchalik parolni doimiy parolga almashtiring.",
force_password_new_label: "Yangi parol",
force_password_new_placeholder: "Kamida 6 ta belgi",
force_password_confirm_label: "Parolni takrorlang",
force_password_confirm_placeholder: "Parolni qayta kiriting",
...
auth_login_subtitle: "Use the login and password created during registration or provided by the administrator.",
auth_login_label: "Login",
auth_login_placeholder: "e.g. jasurbek_01",
auth_password_label: "Password",
auth_password_placeholder: "Enter your password",
auth_login_btn: "Sign in",
       auth_new_user_btn: "New user",
auth_back_to_login_btn: "Back to sign in",

reg_country_label: "Country",
reg_country_hint: "For now, the main focus is Central Asia.",
...
reg_auth_block_title: "Login details",
reg_auth_block_subtitle: "This login and password will be your key to the app.",
reg_login_label: "Login",
reg_login_placeholder: "e.g. jasurbek_01",
reg_password_label: "Password",
reg_password_placeholder: "Minimum 6 characters",
reg_password_confirm_label: "Repeat password",
reg_password_confirm_placeholder: "Repeat your password",

auth_invalid_login: "Please enter a valid login: letters, numbers, and _ . - only.",
auth_invalid_password: "Password must be at least 6 characters.",
auth_password_mismatch: "Passwords do not match.",
auth_login_taken: "This login is already taken.",
auth_login_failed: "Sign in failed. Check your login and password.",
auth_signup_failed: "Could not create the account. Please try again.",

force_password_title: "Change password",
force_password_subtitle: "For security, replace the temporary password with your permanent one.",
force_password_new_label: "New password",
force_password_new_placeholder: "Minimum 6 characters",
force_password_confirm_label: "Repeat password",
force_password_confirm_placeholder: "Repeat your password",
