...
begin
  ...
  if v_checked<>46 or v_learning<>46 then
    raise exception 'written-understanding: expected all 46 checked tasks to have a published learning assessment; checked=%, learning=%',v_checked,v_learning;
  end if;
