...
begin
  ...
  if v_checked<>36 or v_learning<>36 then
    raise exception 'written-understanding: expected all 36 checked tasks to have a published learning assessment; checked=%, learning=%',v_checked,v_learning;
  end if;
