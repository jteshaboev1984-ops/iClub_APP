...
begin
  ...
  if v_checks<>52 or v_tasks<>49 then
    raise exception 'written-understanding: curated scope changed; expected 52 checks across 49 tasks, got % across %',v_checks,v_tasks;
  end if;
  ...
  if v_p1_checks<>26 or v_p1_tasks<>23 or v_p5_checks<>26 or v_p5_tasks<>26 then
