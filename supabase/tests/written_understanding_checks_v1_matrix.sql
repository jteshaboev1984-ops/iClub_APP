...
begin
  ...
  if v_checks<>49 or v_tasks<>46 then
    raise exception 'written-understanding: curated scope changed; expected 49 checks across 46 tasks, got % across %',v_checks,v_tasks;
  end if;
  ...
  if v_p1_checks<>23 or v_p1_tasks<>20 or v_p5_checks<>26 or v_p5_tasks<>26 then
  ...
  if v_single<>44 or v_multi<>2 or v_max<>3 then
