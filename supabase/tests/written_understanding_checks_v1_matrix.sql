...
begin
  ...
  if v_checks<>47 or v_tasks<>44 then
    raise exception 'written-understanding: curated scope changed; expected 47 checks across 44 tasks, got % across %',v_checks,v_tasks;
  end if;
  ...
  if v_p1_checks<>22 or v_p1_tasks<>19 or v_p5_checks<>25 or v_p5_tasks<>25 then
  ...
  if v_single<>42 or v_multi<>2 or v_max<>3 then
